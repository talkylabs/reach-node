...
import { AuthenticationTrialItemListInstance } from "./authentix/authenticationTrialItem";
import { AuthenticationTrialStatItemListInstance } from "./authentix/authenticationTrialStatItem";
import { ConfigurationItemListInstance } from "./authentix/configurationItem";

export default class Authentix extends Version {
  /**
  ...
  /** authenticationTrialItems - { Reach.Api.Authentix.AuthenticationTrialItemListInstance } resource */
  protected _authenticationTrialItems?: AuthenticationTrialItemListInstance;
  /** authenticationTrialStatItems - { Reach.Api.Authentix.AuthenticationTrialStatItemListInstance } resource */
  protected _authenticationTrialStatItems?: AuthenticationTrialStatItemListInstance;
  /** configurationItems - { Reach.Api.Authentix.ConfigurationItemListInstance } resource */
  protected _configurationItems?: ConfigurationItemListInstance;

  /** Getter for authenticationTrialItems resource */
  get authenticationTrialItems(): AuthenticationTrialItemListInstance {
    this._authenticationTrialItems = this._authenticationTrialItems || AuthenticationTrialItemListInstance(this);
    return this._authenticationTrialItems;
  }

  /** Getter for authenticationTrialStatItems resource */
  get authenticationTrialStatItems(): AuthenticationTrialStatItemListInstance {
    this._authenticationTrialStatItems = this._authenticationTrialStatItems || AuthenticationTrialStatItemListInstance(this);
    return this._authenticationTrialStatItems;
  }

  /** Getter for configurationItems resource */
  get configurationItems(): ConfigurationItemListInstance {
    this._configurationItems = this._configurationItems || ConfigurationItemListInstance(this);
